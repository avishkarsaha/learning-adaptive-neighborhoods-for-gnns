...
parser.add_argument(
    "--expname", type=str, default="debug_lg", help="experiment name"
)
...
def train(
        ...
        train_labels, train_nodes, loss_fcn, device, writer
):
    model.train()
    loss_tra = 0
    acc_tra = 0
...
if __name__ == "__main__":
    ...
    train_labels, val_labels, test_labels, train_nodes, val_nodes, test_nodes = load_ppi()
    cudaid = "cuda"
